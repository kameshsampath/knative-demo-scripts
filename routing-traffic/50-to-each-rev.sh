...
cat "$TUTORIAL_HOME/03-configs-and-routes/route/route_rev1-50_rev2-50.yaml" | yq w - 'spec.traffic[0].revisionName' $REVISION_1 | yq w - 'spec.traffic[1].revisionName' $REVISION_2 |  oc apply -n knativetutorial -f -
